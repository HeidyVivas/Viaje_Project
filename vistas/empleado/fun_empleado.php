...
// Consultar reservas
$sql = "
    SELECT r.id, u.nombre AS nombre, u.telefono, v.destino, r.cantidad_personas,
...
<body class="bg-gray-100 p-8">
  ...
  <div class="max-w-5xl mx-auto bg-white rounded-xl shadow-md p-6">
    <h2 class="text-2xl font-semibold mb-4">📋 Sistema de Reservas — Panel de Empleado</h2>
    ...
    <table class="w-full border-collapse border border-gray-300 text-sm">
      ...
      <tbody>
        ...
        <tr class="text-center">
          <td class="border border-gray-300 px-2 py-1"><?= htmlspecialchars($r['nombre']) ?></td>
