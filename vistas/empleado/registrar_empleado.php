...
<body class="min-h-screen flex items-center justify-center bg-[url(https://encolombia.com/wp-content/uploads/2013/02/San-Andres-Colombia.jpeg)]">
  ...
  <div class="bg-white p-8 rounded-2xl shadow-md w-96 text-center">
    <h2 class="text-xl font-semibold mb-6">Registro — <span class="text-sky-600">Empleado</span></h2>

    <form action="../procesos/registrar_empleado_proceso.php" method="POST" class="space-y-4">
    ...
    <p class="mt-4 text-sm text-gray-600">
      ¿Ya tienes cuenta?
      <a href="login_empleado.php" class="text-sky-600 hover:underline">Inicia sesión</a>
    </p>
